...
def generate_tdnn_model():
    ...
    gemm_node1=onnx.helper.make_node('Gemm', inputs=['relu_out3', 'gemm_params1', 'gemm_bias1'],
                                outputs=['gemm_out1']
                                )
    ...
    graph = onnx.helper.make_graph([node1, relu_node1, node2, relu_node3, gemm_node1, gemm_mul_node1, gemm_relu_node1, node4, relu_node4, gemm_node2, gemm_mul_node2, gemm_relu_node2, add_node, mul_node, relu_node7,gemm_node, gemm_mul_node, gemm_relu_node, node8], "tdnn_bb04p1_hua_shibie",
...
def test_forward_hua_shibie():
    np.random.seed(10)
    generate_tdnn_model()
    test_model()

if __name__ == '__main__':
    test_forward_hua_shibie()
