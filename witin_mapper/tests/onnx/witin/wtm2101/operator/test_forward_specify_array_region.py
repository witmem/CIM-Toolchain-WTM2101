...
#
# Last modified: 2022-09-26 13:52
#
# Filename: test_forward_specify_array_region.py
#
# Description:
#
# =============================================================================*/
...
def get_tvm_output(model_path):
    ...
    optimize_config = "./model/optimize_layer/specify_array_region.protobuf"
...
def generate_tdnn_model():
    ...
    model = helper.make_model(graph, producer_name='specify_array_region')
    date_time = datetime.datetime.now()
    timestamp = date_time.strftime("%d_%b_%Y_%H_%M_%S_%f")
    model_path = "./model/specify_array_region_" + timestamp + ".onnx"
...
def test_forward_specify_array_region():
    np.random.seed(10)
...
if __name__ == '__main__':
    test_forward_specify_array_region()
