...
def test_model_case1():
    ...
    opt_config_files = [root_dir + "/optimize_layer/optimize_config_gru.protobuf",
           root_dir + "/optimize_layer/optimize_config_gru_partial_PN.protobuf"]
...
def test_model_case2():
    ...
    target = "npu"
    ctx = "npu"
    opt = root_dir + "/optimize_layer/optimize_config_lstm.protobuf"
