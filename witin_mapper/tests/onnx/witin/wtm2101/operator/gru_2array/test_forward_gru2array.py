...
def generate_gru_model():
    ...
    with open(root_dir + 'test_gru_2_array' + '.onnx', "wb") as of:
        of.write(model.SerializeToString())
    print("generate {} sucessfully!".format('test_gru_2_array'  + '.onnx'))
      
def run_model():
    input_len = 392
    file_name = root_dir + 'test_gru_2_array'  + '.onnx'
    ...
    opti = './tests/onnx/witin/wtm2101/operator/gru_2array/gru.protobuf'
