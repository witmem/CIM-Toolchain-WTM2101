...
def run_model():
    input_len = 50
    file_name = './tests/onnx/witin/wtm2101/operator/gru_2array/gru2array_gru2array_dnn_network.onnx'
    ...
    opti = './tests/onnx/witin/wtm2101/operator/gru_2array/gru_gru_dnn.protobuf'
