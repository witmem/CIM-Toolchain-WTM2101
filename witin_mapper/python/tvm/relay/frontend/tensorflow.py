...
def _elemwise(name):
    def _impl(inputs, attr, params, mod):
        ...
        if name == "npu_mul" or name == "npu_add":
            return get_relay_op(name)(*inputs, shift_bit)
        else :
...
def _bias_add():
    def _impl(inputs, attr, params, mod):
        ...
        if 'data_format' in attr and \
            ...
            bias = inputs[1]
        #afly 13/10/2020
        return  _op.nn.bias_add(inputs[0], bias)
