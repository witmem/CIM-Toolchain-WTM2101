...
class AttrCvt(object):
    ...
    def __call__(self, inputs, attrs, *args):
        ...
        if 'input_dim' in new_attrs:
            new_attrs.pop('input_dim')
        if 'output_dim' in new_attrs:
            new_attrs.pop('output_dim')
...
class Renamer(object):
    ...
    def __call__(self, inputs, attrs, *args):
        ...
        if 'input_dim' in attrs:
            attrs.pop('input_dim')
        if 'output_dim' in attrs:
            attrs.pop('output_dim')
